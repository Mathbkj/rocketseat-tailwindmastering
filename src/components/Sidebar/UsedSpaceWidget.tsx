...
export const UsedSpaceWidget: FC = () => {
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      <div className="space-y-1">
        ...
        <p className="text-sm/5 text-violet-500 dark:text-zinc-400">
          Your team has used 90% of your available space. Need more?
        </p>
      </div>
      ...
      <div className="space-x-3">
        <button
          type="button"
          className="text-sm font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-200 dark:text-violet-300"
        >
          Dismiss
        </button>
        <button
          type="button"
          className="text-sm font-medium text-violet-700 hover:text-violet-900 dark:hover:text-zinc-100 dark:text-zinc-300"
        >
          Upgrade Plan
        </button>
      </div>
